...
from peng.model.losses import Seq2SeqLoss, Seq2SetLoss
...
parser.add_argument('--dataset_name', default='penga/14res', type=str)
...
parser.add_argument('--bart_name', default='/home/lijiangnan/bart-base', type=str)
